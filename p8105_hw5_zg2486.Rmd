...
power_plot
```
The plot shows that power increases as the true mean (𝜇) increases, because as the true effect size (difference between the null hypothesis value and the true mean) becomes larger, it becomes easier to reject the null hypothesis, resulting in higher power.
